...
<body>
						...
						<div class="input-group-btn">
							...
							<ul class="dropdown-menu">
								<c:forEach var="category" items="${categories}">
									<li><a
										onclick="selectCategory('${category.name}','${category.displayName}','${category.id}');">${category.displayName}</a>
									</li>
								</c:forEach>
							</ul>
						</div>
	...
	<script type="text/javascript">
		...
		$(function() {
			testEditor = editormd("test-editormd", {
				...
				imageUploadURL : "./uploadPicture?json"
	...
	<script>
		function selectCategory(name, displayName,id) {
